...
const page = () => {
    ...
    const [keywords, setKeywords] = useState(["blue", "well", "manage", "excuse", "helmet", "material", "shape", "pilot", "copyright"])
    ...
    const badges = <div className="px-4 py-4 bg-neutral-100 dark:bg-neutral-800 mx-8 h-full mb-8 w-11/12 mr-8 ">
        ...
        <div className="flex flex-col items-start my-4 p-4 h-full w-full">
            ...
            <div className='flex flex-row w-11/12'>
                ...
                <div className='flex flex-row justify-end w-full pr-8'>
                    ...
                    <button onClick={()=> setEdit((edit) => !edit)} className="px-8 py-2 ml-10 my-6 rounded-md border border-neutral-300 bg-neutral-100 text-neutral-500 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md">
                        {edit ? 'Submit' : 'Edit'}
                    </button>
                </div>
            </div>
